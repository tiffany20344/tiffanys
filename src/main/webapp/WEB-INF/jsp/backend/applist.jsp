...
<div class="row">
	...
	<div class="col-md-12">
		<div class="x_panel">
			...
			<div class="x_content">
				<form method="post" action="/mag/info/app">
							...
							<ul class="pagination">
								<c:if test="${pageNo > 1}">
									<li class="paginate_button previous"><a
										href="/mag/info/app?currentPageNo=1"
										aria-controls="datatable-responsive" data-dt-idx="0"
										tabindex="0">首页</a>
									</li>
									<li class="paginate_button "><a
										href="/mag/info/app?currentPageNo=${pageNo-1}"
								...
								<c:if test="${pageNo < totalPageCount }">
									...
									<li class="paginate_button next"><a
										href="/mag/info/app?currentPageNo=${totalPageCount}"
